...
var WISYWYG_helper_switchEditors = {
    ...
    go : function(id) {
        var ta = jQuery('textarea[name="'+id+'"]');
        try {
            ed = jQuery("span#"+id+"_parent");
        }
        catch(e) {
            ed = false;
        }
        ...
        if ( ed && ed.is(":visible") ) {
            //Hiding editor, showing textarea
            ta.css({
                color : '#000'
            });
            ...
            //Showing editor, hiding textarea
            ta.css({
                color : '#FFF'
            });
            ta.val(this.wpautop(ta.val()));
